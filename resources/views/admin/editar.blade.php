...
<body class="bg-dark h-100">
        ...
        <div class="container-fluid">
            <div class="row">
                <div style="width: 250px;">
                    <img src="{{asset('admin/img/kbrtec.webp')}}" alt="KBRTEC" height="60" width="150" class="object-fit-contain">
                </div>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="{{ route('admin.atualizar', $user->id) }}" method="POST" class="bg-custom rounded col-12 py-3 px-4">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select name="type" class="form-select bg-dark text-light border-dark">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="username" value="{{ $user->username }}" class="form-control bg-dark text-light border-dark" placeholder="Ex: Admin">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" name="email" value="{{ $user->email }}" class="form-control bg-dark text-light border-dark" placeholder="Ex: admin@kbrtec.com.br">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="password" class="form-control bg-dark text-light border-dark">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="password_confirmation" class="form-control bg-dark text-light border-dark">
                    </div>
                </div>
