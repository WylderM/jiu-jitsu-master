...
<body class="bg-dark h-100">
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <main class="col h-100 text-light p-4">
            ...
            <form action="{{ route('admin.cadastrar') }}" method="post" class="bg-custom rounded col-12 py-3 px-4">
                @csrf <!-- Adicione o campo CSRF token -->
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="username" class="form-control bg-dark text-light border-dark" id="usuario" placeholder="Ex: Admin">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="password_confirmation" class="form-control bg-dark text-light border-dark" id="confSenha">
                    </div>
                </div>
