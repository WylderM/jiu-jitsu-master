...
<body class="bg-dark h-100">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="{{ route('admin.editar', ['id' => $user->id]) }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
                                    ...
                                    <form action="{{ route('admin.deletar', ['id' => $user->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
    ...
    <script>
        $('#exampleModal').on('show.bs.modal', function(event) {
            ...
            // Preencha o modal com as informações do usuário
